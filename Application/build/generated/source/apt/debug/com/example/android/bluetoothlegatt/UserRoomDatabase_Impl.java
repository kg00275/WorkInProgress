  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `user_table` (`user` TEXT NOT NULL, PRIMARY KEY(`user`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"7e6574fa70e326d32fefebb8d51a1f5a\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsUserTable = new HashMap<String, TableInfo.Column>(1);
        _columnsUserTable.put("user", new TableInfo.Column("user", "TEXT", true, 1));
        ...
        if (! _infoUserTable.equals(_existingUserTable)) {
          throw new IllegalStateException("Migration didn't properly handle user_table(com.example.android.bluetoothlegatt.User).\n"
                  + " Expected:\n" + _infoUserTable + "\n"
                  + " Found:\n" + _existingUserTable);
        }
      }
    }, "7e6574fa70e326d32fefebb8d51a1f5a", "e38b38292ddb858f9d897029519f6dc2");
